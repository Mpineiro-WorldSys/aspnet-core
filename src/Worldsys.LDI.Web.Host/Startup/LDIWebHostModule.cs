...
using Worldsys.LDI.Web.Startup.ExternalLoginInfoProviders;
...
namespace Worldsys.LDI.Web.Startup
{
    ...
    public class LDIWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LDIWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LDIWebHostModule).GetAssembly());
        }
