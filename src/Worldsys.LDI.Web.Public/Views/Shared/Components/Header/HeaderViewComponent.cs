...
using Worldsys.LDI.Web.Public.Startup;
using Worldsys.LDI.Web.Session;

namespace Worldsys.LDI.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LDIViewComponent
    {
