...
namespace Worldsys.LDI.Web.Public.Startup
{
    [DependsOn(
        typeof(LDIWebCoreModule)
    )]
    public class LDIWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LDIWebFrontEndModule(IWebHostEnvironment env, LDIEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LDIWebFrontEndModule).GetAssembly());
        }
    }
}
