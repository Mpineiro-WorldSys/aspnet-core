...
namespace Worldsys.LDI.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : LDIServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Worldsys.LDI", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
