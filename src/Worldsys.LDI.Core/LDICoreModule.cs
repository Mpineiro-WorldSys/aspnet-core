...
using Worldsys.LDI.Authorization.Ldap;
...
using Worldsys.LDI.DashboardCustomization.Definitions;
using Worldsys.LDI.Debugging;
using Worldsys.LDI.DynamicEntityProperties;
using Worldsys.LDI.Features;
using Worldsys.LDI.Friendships;
using Worldsys.LDI.Friendships.Cache;
using Worldsys.LDI.Localization;
using Worldsys.LDI.MultiTenancy;
using Worldsys.LDI.Net.Emailing;
using Worldsys.LDI.Notifications;
using Worldsys.LDI.WebHooks;

namespace Worldsys.LDI
{
    [DependsOn(
        typeof(LDICoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class LDICoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            LDILocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = LDIConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, LDIMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<LDISmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LDICoreModule).GetAssembly());
        }
