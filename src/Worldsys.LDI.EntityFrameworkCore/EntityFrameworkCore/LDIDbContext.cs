...
{
    public class LDIDbContext : AbpZeroDbContext<Tenant, Role, User, LDIDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public LDIDbContext(DbContextOptions<LDIDbContext> options)
            : base(options)
        {
