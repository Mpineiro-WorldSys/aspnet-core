...
namespace Worldsys.LDI.Migrations
{
    ...
    [Migration("20210419150401_migracionSoloLEctura")]
    partial class migracionSoloLEctura
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Worldsys.LDI.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Worldsys.LDI.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Worldsys.LDI.Phonebook.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Worldsys.LDI.Phonebook.Phone", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Worldsys.LDI.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Worldsys.LDI.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Worldsys.LDI.Phonebook.Phone", b =>
                {
                    b.HasOne("Worldsys.LDI.Phonebook.Person", "Person")
                        .WithMany("Phones")
