...
{
    public class SubscriptionPaymentExtensionDataRepository : LDIRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<LDIDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
