...
using Worldsys.LDI.EntityFrameworkCore.Repositories;

namespace Worldsys.LDI.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : LDIRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<LDIDbContext> dbContextProvider)
