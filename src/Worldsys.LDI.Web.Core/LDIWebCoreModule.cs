...
using Worldsys.LDI.Web.Authentication.JwtBearer;
using Worldsys.LDI.Web.Authentication.TwoFactor;
using Worldsys.LDI.Web.Chat.SignalR;
using Worldsys.LDI.Web.Configuration;
using Worldsys.LDI.Web.DashboardCustomization;

namespace Worldsys.LDI.Web
{
    [DependsOn(
        typeof(LDIApplicationModule),
        typeof(LDIEntityFrameworkCoreModule),
    ...
    public class LDIWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LDIWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(LDIApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LDIWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(LDIWebCoreModule).Assembly);
        }
