...
using Worldsys.LDI.Auditing.Exporting;
...
using EntityHistoryHelper = Worldsys.LDI.EntityHistory.EntityHistoryHelper;

namespace Worldsys.LDI.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : LDIAppServiceBase, IAuditLogAppService
    {
