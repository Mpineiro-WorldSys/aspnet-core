...
namespace Worldsys.LDI.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : LDIAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<LDIDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{LDIConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{LDIConsts.ConnectionStringName}", constring);
        }
