...
using Worldsys.LDI.Authorization.Users.Profile.Cache;
using Worldsys.LDI.Authorization.Users.Profile.Dto;
using Worldsys.LDI.Configuration;
using Worldsys.LDI.Friendships;
using Worldsys.LDI.Gdpr;
using Worldsys.LDI.Net.Sms;
using Worldsys.LDI.Security;
using Worldsys.LDI.Storage;
using Worldsys.LDI.Timing;

namespace Worldsys.LDI.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : LDIAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Worldsys.LDI",
