...
using Worldsys.LDI.Web.Models.Payment;
using System;
...
{
    public class PaymentController : LDIControllerBase
    {
                ...
                if (tenant.EditionId.HasValue)
                {
                    ...
                    if (((SubscribableEdition)currentEdition).IsFree)
                    {
                        ...
                        if (((SubscribableEdition)upgradeEdition).IsFree)
                        {
                            ...
                            return RedirectToAction("Index", "SubscriptionManagement", new { area = "AppName" });
                        }
