...
using Worldsys.LDI.Authorization.Accounts;
using Worldsys.LDI.Authorization.Accounts.Dto;
using Worldsys.LDI.Authorization.Delegation;
using Worldsys.LDI.Authorization.Impersonation;
...
using Worldsys.LDI.Net.Sms;
using Worldsys.LDI.Notifications;
using Worldsys.LDI.Web.Models.Account;
using Worldsys.LDI.Security;
using Worldsys.LDI.Security.Recaptcha;
using Worldsys.LDI.Sessions;
using Worldsys.LDI.Url;
using Worldsys.LDI.Web.Authentication.External;
using Worldsys.LDI.Web.Security.Recaptcha;
using Worldsys.LDI.Web.Session;
using Worldsys.LDI.Web.Views.Shared.Components.TenantChange;

namespace Worldsys.LDI.Web.Controllers
{
    public class AccountController : LDIControllerBase
    {
        ...
        {
            return RedirectToAction("Index", "Home", new { area = "AppName" });
        }

        public string GetAppHomeUrl()
        {
            return Url.Action("Index", "Home", new { area = "AppName" });
        }
