...
using Worldsys.LDI.Schemas;
using Worldsys.LDI.Web.Chat.SignalR;
using Worldsys.LDI.Web.Common;
using Worldsys.LDI.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Worldsys.LDI.Web.IdentityServer;
using Worldsys.LDI.Web.Swagger;
using Stripe;
...
using Worldsys.LDI.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace Worldsys.LDI.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() {Title = "LDI API", Version = "v1"});
            ...
            return services.AddAbp<LDIWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "LDI API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Worldsys.LDI.Web.wwwroot.swagger.ui.index.html");
