...
namespace Worldsys.LDI.Web.Startup
{
    ...
    public class LDIWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LDIWebMvcModule(IWebHostEnvironment env)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Navigation.Providers.Add<AppNameNavigationProvider>();
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LDIWebMvcModule).GetAssembly());
        }
