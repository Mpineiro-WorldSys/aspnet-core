...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['Worldsys.LDI.MyNotificationDataType'] = function(userNotification) {
            ...
            */
            ...
            function getUrl(userNotification) {
                switch (userNotification.notification.notificationName) {
                    case 'App.NewUserRegistered':
                        return '/AppName/users?filterText=' + userNotification.notification.data.properties.emailAddress;
                    case 'App.NewTenantRegistered':
                        return '/AppName/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
            ...
            var openSettingsModal = function () {
                new app.ModalManager({
                    viewUrl: abp.appPath + 'AppName/Notifications/SettingsModal',
                    scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Notifications/_SettingsModal.js',
