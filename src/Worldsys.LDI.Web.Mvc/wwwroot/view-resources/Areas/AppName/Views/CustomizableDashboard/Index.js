$(function () {
    ...
    var _addWidgetModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppName/' + $('#DashboardName').val() + '/AddWidgetModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/CustomizableDashboard/_AddWidgetModal.js',
