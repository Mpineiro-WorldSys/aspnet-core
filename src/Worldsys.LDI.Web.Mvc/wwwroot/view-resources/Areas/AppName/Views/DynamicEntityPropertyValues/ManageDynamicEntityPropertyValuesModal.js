(function () {
    ...
    app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
