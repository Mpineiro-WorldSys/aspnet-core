(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Languages/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "AppName/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {
