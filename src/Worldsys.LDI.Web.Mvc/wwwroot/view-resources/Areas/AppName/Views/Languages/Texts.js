(function () {
    $(function () {
        ...
        var _editTextModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Languages/EditTextModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Languages/_EditTextModal.js',
        ...
        var dataTable = _$textsTable.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    defaultContent: '',
                    rowAction: {
                        element: $('<button class="btn btn-outline-primary btn-sm btn-icon" title="' + app.localize('Edit') + '"><i class="la la-edit"></i></button>')
                            .click(function () {
                                var data = $(this).data();
                                _editTextModal.open({
                                    sourceName: $('#TextSourceSelectionCombobox').val(),
