(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'Worldsys.LDI.MultiTenancy.Tenant';
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "AppName/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/AppName/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "AppName/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/AppName/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "AppName/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/AppName/Views/Tenants/_FeaturesModal.js",
