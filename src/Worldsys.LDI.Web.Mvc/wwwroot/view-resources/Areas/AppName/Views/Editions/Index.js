(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Editions/_CreateModal.js',
            modalClass: 'CreateEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Editions/_EditModal.js',
            modalClass: 'EditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
