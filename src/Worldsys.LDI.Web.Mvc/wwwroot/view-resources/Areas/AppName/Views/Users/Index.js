(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Users/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Users/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditUserModal'
        });

        var _userPermissionsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Users/PermissionsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Users/_PermissionsModal.js',
            modalClass: 'UserPermissionsModal'
        });

        var _dynamicPropertiesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/_Bundles/manage-dynamic-entity-property-values-modal-min.js',
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _dynamicPropertiesModal.open({
                                    entityFullName: 'Worldsys.LDI.Authorization.Users.User',
