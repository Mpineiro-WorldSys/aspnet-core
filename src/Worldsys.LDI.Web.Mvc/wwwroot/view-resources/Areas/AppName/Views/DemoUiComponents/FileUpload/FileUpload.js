$(function () {
    ...
    var url = abp.appPath + 'AppName/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        dropZone: $('#fileuploadForm'),
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'AppName/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;
