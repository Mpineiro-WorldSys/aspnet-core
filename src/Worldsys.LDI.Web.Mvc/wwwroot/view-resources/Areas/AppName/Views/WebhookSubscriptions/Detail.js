(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/WebhookSubscription/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/WebhookSubscriptions/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        },
                        {
                            ...
                            action: function (data) {
                                window.location = "/AppName/WebhookSubscription/WebhookEventDetail/" + data.record.webhookEventId;
                            }
                        }]
                    }
                },
