(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/DynamicProperty/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/DynamicProperties/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDynamicPropertyModal',
            cssClass: 'scrollable-modal'
        });

        var _manageValuesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/DynamicProperty/ManageValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/_Bundles/dynamic-properties-manage-values.min.js',
