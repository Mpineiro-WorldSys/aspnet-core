(function () {
    $(function () {
        ...
        var _selectAnEntity = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/DynamicProperty/SelectAnEntityModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/DynamicProperties/_SelectAnEntityModal.js',
                    ...
                    },
                    {
                        ...
                        rowAction: {
                            element: $("<button/>")
                                ...
                                .click(function () {
                                    window.location.href = "/AppName/DynamicEntityProperty/" + $(this).data().entityFullName;
                                })
                        }
                    },
                    {
