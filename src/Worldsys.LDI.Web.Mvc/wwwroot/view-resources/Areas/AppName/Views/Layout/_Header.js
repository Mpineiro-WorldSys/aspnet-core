(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Profile/_LinkedAccountsModal.js',
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppName/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppName/Views/Profile/_UserDelegationsModal.js',
