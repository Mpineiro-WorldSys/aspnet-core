...
namespace Worldsys.LDI.Web.Areas.AppName.Views.Shared.Components.AppNameMenu
{
    public class AppNameMenuViewComponent : LDIViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public AppNameMenuViewComponent(
        ...
        public async Task<IViewComponentResult> InvokeAsync(bool isLeftMenuUsed, string currentPageName = null)
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(AppNameNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, AppNamePageNames.Tenant.SubscriptionManagement);
