...
using Worldsys.LDI.MultiTenancy.HostDashboard;
...
namespace Worldsys.LDI.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LDIDbContext context, SubscriptionPayment subscriptionPayment)
        {
